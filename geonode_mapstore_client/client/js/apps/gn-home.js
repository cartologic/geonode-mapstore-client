...
import { setupConfiguration, initializeApp } from "@js/utils/AppUtils";
...
const routes = [
    ...
    {
        name: "resources",
        path: ["/search/", "/search/:pk", "/search/:ctype/:pk"],
...
Promise.all([
    ...
    const { securityState, geoNodeConfiguration } = setupConfiguration({
        localConfig,
        user,
        resourcesTotalCount,
    });
